                    ...
                    <div class="product-image-wrapper">
                        <div class="single-products">
                            <div class="productinfo text-center">
                                ...
                                <p>{{ $product->name }}</p>
                                <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-crosshairs"></i>Mais
                                    detalhes</a>
                    ...
                    <div class="single-products">
                        ...
                        <div class="product-overlay">
                            <div class="overlay-content">
                                ...
                                <a href="http://commerce.dev:10088/cart/5/add" class="btn btn-default add-to-cart"><i
                                            class="fa fa-shopping-cart"></i>Adicionar no carrinho</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="product-image-wrapper">
                    <div class="single-products">
                        <div class="productinfo text-center">
                            ...
                            <h2>R$ 34.343,00</h2>
                            <p>fdsfsfdsfs</p>
                            <a href="http://commerce.dev:10088/product/42" class="btn btn-default add-to-cart"><i
                                        class="fa fa-crosshairs"></i>Mais detalhes</a>
                        ...
                        <div class="product-overlay">
                            <div class="overlay-content">
                                ...
                                <a href="http://commerce.dev:10088/cart/42/add" class="btn btn-default add-to-cart"><i
                                            class="fa fa-shopping-cart"></i>Adicionar no carrinho</a>
                            </div>
                        </div>
                    </div>
